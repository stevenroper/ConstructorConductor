...
function User(name, email, pw, totalScore) {
    this.name = name;
    this.email = email;
    this.password = pw;
...
var user1 = new User('Steven', 'steven@dev.com', 'blah123', 125);
var user2 = new User('David', 'dave@dev.com', 'asdfASDF', 40);
var user3 = new User('Sally', 'sally@mountain.com', '1212ijij', 400);
